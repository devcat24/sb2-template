...
public interface MemberRepo extends JpaRepository<Member, Long> {
    ...
    @Query("SELECT m FROM com.github.devcat24.mvc.entity.mm.Member m WHERE m.id > ?1")
    ...
    @Query("SELECT m FROM com.github.devcat24.mvc.entity.mm.Member m WHERE m.id > :queryID")
    ...
    @Query("SELECT                                                                                                                                   " +
            "    new com.github.devcat24.mvc.dto.mm.MemberDTO (m.id as id, m.name as name, m.city as city, m.street as street, m.zipcode as zipcode) " +
            " FROM com.github.devcat24.mvc.entity.mm.Member m WHERE m.id > :queryID                                                                     ")
