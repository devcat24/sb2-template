...
public interface MemberRepo extends JpaRepository<Member, Long> {
 ...
 @Query("SELECT m FROM com.github.devcat24.mvc.db.entity.mm.Member m WHERE m.id > :queryID")
 ...
 @Query("SELECT                                                                                                                                   " +
       ...
       "   FROM com.github.devcat24.mvc.db.entity.mm.Member m WHERE m.id > :queryID                                                                     ")
